...
- `processor.max_cstate=1` - mantiene el CPU en C-states superficiales, reduce latencia de wake.
...
## Bloqueo de P-states AMD

Evita que el CPU baje de la frecuencia máxima:
...
Reiniciar y elegirlo desde GRUB.
...
Reemplazar todo lo que sigue al comentario de umask con:
...
Mover el bloque de source de `.bashrc` al final, después del PATH.
