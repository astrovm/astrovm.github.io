...
`$ sudo dnf install tmux @virtualization alacritty kitty android-tools arc-theme aria2 curl emacs exa firewall-config flatpak gamemode git gparted gzip kgpg lutris neofetch neovim net-tools obs-studio p7zip p7zip-plugins qemu steam tor torsocks tree util-linux-user virt-manager wireguard-tools`
