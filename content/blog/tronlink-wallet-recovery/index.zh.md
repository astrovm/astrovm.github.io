...
借助 Grok，我找到了 **CVE-2024-31317**，这是 `ZygoteProcess.java` 里的一个 bug，在 2024 年 6 月的补丁里修复了。这个 exploit 能让你以设备上**任何 app** 的身份执行代码，包括系统应用。不需要 root，只需要 `adb`。像 Oxygen 这种取证软件也用的同一个 exploit，全世界的警察和情报机构都拿它来提取手机数据。
