...
Kubuntu 26.04.1をUEFIモードでインストール。両方のNVMeでLUKS2を使用。
...
Linux上で**Sonic Adventure DX**と**Sonic Adventure 2**のmodを設定するために[Adventure Mods](https://github.com/astrovm/AdventureMods)を使う。
...
Adventure Modsを起動してセットアップウィザードに従う。
